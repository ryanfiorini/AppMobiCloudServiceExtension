...
namespace AppMobiCloudServiceExtension_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        public void ValidateToolWindowShown()
        {
            ...
            MethodInfo method = typeof(AppMobiCloudServiceExtensionPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
