...
namespace AppMobiCloudServiceExtension_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new AppMobiCloudServiceExtensionPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(appMobi.AppMobiCloudServiceExtension.GuidList.guidAppMobiCloudServiceExtensionCmdSet, (int)appMobi.AppMobiCloudServiceExtension.PkgCmdIDList.cmdidAppMobiCloudServiceCommand);
